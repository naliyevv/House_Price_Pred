...
st.sidebar.write('Created and Designed by [Jonaben](https://www.linkedin.com/in/jonathan-ben-okah-7b507725b)')
...
def predict(longitude, latitude, housing_median_age, total_rooms, total_bedrooms,
    ...
    # scaling the data
    scaler.transform([[longitude, latitude,housing_median_age, total_rooms, total_bedrooms,
                       population, households, med_income, ocean]])
    # making predictions using the train model
    prediction = model.predict([[longitude, latitude, housing_median_age, total_rooms, total_bedrooms,
                               population, households, med_income, ocean]])
